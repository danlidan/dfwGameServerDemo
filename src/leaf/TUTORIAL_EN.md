...
A game server implemented with Leaf may include many modules (e.g. [LeafServer](https://leafserver)) which all share below traits:
...
[LeafServer](https://leafserver) is a game server developped with Leaf. Let's start with it.

Download the source code of LeafServer：

```
git clone https://leafserver
```
